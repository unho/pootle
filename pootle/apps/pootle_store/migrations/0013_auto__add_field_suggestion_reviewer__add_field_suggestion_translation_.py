...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'pootle_store_suggestion', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.User']))

        # Changing field 'TMUnit.submitted_by'
        db.alter_column(u'pootle_store_tmunit', 'submitted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.User']))

        # Changing field 'Unit.commented_by'
        db.alter_column(u'pootle_store_unit', 'commented_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.User']))

        # Changing field 'Unit.submitted_by'
        db.alter_column(u'pootle_store_unit', 'submitted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounts.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Suggestion.user'
        db.alter_column(u'pootle_store_suggestion', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pootle_profile.PootleProfile'], null=True))

        # Changing field 'TMUnit.submitted_by'
        db.alter_column(u'pootle_store_tmunit', 'submitted_by_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pootle_profile.PootleProfile']))
